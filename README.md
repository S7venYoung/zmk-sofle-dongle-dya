...
| 设置 | 作用 | 范围 |
| --- | --- | --- |
| `display_theme` | OLED 主题 | `0`=Classic，`1`=YADS，`2`=仪表盘 |
...
`4.1-display-themes` 在保留当前 Classic 猫咪主题的基础上增加 YADS 信息主题和汽车仪表盘主题。通过 DYA Studio 将 `display_theme` 写为 `0`、`1` 或 `2` 后立即切换，点击页面顶部的 `Save` 后持久保存。
