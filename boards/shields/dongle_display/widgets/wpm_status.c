...
static lv_point_precise_t brace_target(int value, bool right) {
    ...
    lv_point_precise_t low = {20, 41};
    lv_point_precise_t middle = {10, 24};
    lv_point_precise_t high = {42, 1};
...
int zmk_widget_wpm_status_init(struct zmk_widget_wpm_status *widget, lv_obj_t *parent) {
    ...
    widget->current_points[1] = (lv_point_precise_t){20, 41};
    ...
    widget->peak_points[1] = (lv_point_precise_t){107, 41};
